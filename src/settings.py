...
##################################
LICENSE: License = License.CC_BY_NC_ND_4_0(source_url="https://www.sciencedirect.com/science/article/pii/S1569843222001595#fn1")
...
AUTHORS_CONTACTS: Optional[List[str]] = ["weihan@cug.edu.cn"]
